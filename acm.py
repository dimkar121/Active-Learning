...
faiss.normalize_L2(dblp_embeddings) # Normalize for inner product (cosine sim)
...
for acm_idx, dblp_indices in enumerate(I):
    ...
    for dblp_idx in dblp_indices:
        ...
        y_true_list_stage1.append(1.0 if (acm_id, dblp_id) in gt_lookup else 0.0)
...
if len(stage2_candidate_indices) > 0:
    ...
    for idx in stage2_candidate_indices:
        ...
        hybrid_features = lib.create_hybrid_feature_vector(amazon_record, google_record, col="title")
