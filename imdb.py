...
embeddings_a_whole = np.array(df_a_whole['v'].tolist()).astype('float32')
d = embeddings_a_whole.shape[1]
index = faiss.IndexHNSWFlat(d, 32, faiss.METRIC_INNER_PRODUCT)
index.hnsw.efConstruction = 60
index.hnsw.efSearch = 64
faiss.normalize_L2(embeddings_a_whole)
index.add(embeddings_a_whole)
